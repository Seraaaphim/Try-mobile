...
export const SignIn = () => {
  <View style={styles.container}>
    <Text style={[styles1.setFontSizeThree, { fontWeight: "bold" }]}>
      SIGN IN
    </Text>

    <Text style={{ paddingTop: 5, opacity: 0.5 }}>Welcome back! </Text>
    ...
    >
      <Button onPress={this.buttonClickListener} title="LOGIN" color="red" />
    </View>
